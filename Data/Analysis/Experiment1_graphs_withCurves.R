...
################################################################
png("Analysis/Figures/Analysis_experiment1_withCurves_normalized_linaloolandTMA.png", width = 600, height = 1000)
...
#     )
    ...
    #plot
    png("Analysis/Figures/Analysis_experiment1_withCurves_normalized_Linalool.png", width = 800, height = 1000)
...
#plot
#png("Analysis/Figures/Experiment1_rawData_TMA.png", width = 600, height =960)
ggplot(summary_test, aes(x = Concentration, y = Intensity)) +
  geom_point() +
  geom_line(data = new_data_for_plot, aes(x = Concentration, y = Prediction)) +
  geom_ribbon(data = new_data_for_plot, aes(x = Concentration, y = Prediction, ymin = Lower, ymax = Upper), alpha = 0.1) +
